...
int main(int argc, char** argv) {
    ...
    if (!success) {
        ...
        printf("Entrei ERROR::SHADER::VERTEX::COMPILATION_FAILED\n%s\n", info_log);
    }
    ...
    if (!success) {
        ...
        printf("Entrei 2 ERROR::SHADER::FRAGMENT::COMPILATION_FAILED\n%s\n", info_log);
    }
    ...
    if (!success) {
        ...
        printf("Entrei 3 ERROR::SHADER::PROGRAM::LINKING_FAILED\n%s\n", info_log);
    }
